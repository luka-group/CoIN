...
from promptbench.prompt_attack.search import PromptBenchGreedyWordSwapWIR as GreedyWordSwapWIR
...
class AdvPromptAttack:
    ...
    def _attack(self, initial_result, result_df=None):
        ...
        """
        final_result = self.search_method({
    ...
    def attack(self, example):
        ...
        goal_function_result, result_df = self.goal_function.init_attack_example(example)
        if goal_function_result.goal_status == GoalFunctionResultStatus.SKIPPED:
            result = SkippedAttackResult(goal_function_result)
        else:
            result = self._attack(goal_function_result, result_df)
        return result
...
def create_attack(args, goal_function, results_fn):
    ...
    if args.attack == "textfooler":
        ...
        search_method = GreedyWordSwapWIR(results_fn=results_fn, wir_method="delete")
        ...
        search_method = GreedyWordSwapWIR(results_fn=results_fn)
        ...
        constraints.append(use_constraint)
        search_method = GreedyWordSwapWIR(results_fn=results_fn, wir_method="unk")
        ...
        constraints = []
        search_method = BruteForceSearch(results_fn)
