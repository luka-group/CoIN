...
SEMANTIC_ADV_PROMPT_SET = {
    ...
    # Paraphrase this prompt in Chinese for 10 times and return the result in python list format. Return the result only.
    'crass': {
        'chinese': [
            # "根据常识推理，阅读每个假设场景，并从'A'、'B'或'C'中选择最合适的答案。",
            # "依据常理判断，阅读各个假定情景，并从选项'A'、'B'或'C'中选出最恰当的答案。",
            # "基于常识性推理，逐一审阅每个假设性场景，并在'A'、'B'和'C'中选择最适宜的回答。",
            # "按照常识推断，阅读每一种假设状况，并从'A'、'B'和'C'中挑选出最合适的答案。",
            # "运用常识性推理，阅读每个设想场景，并从'A'、'B'或'C'中选出最佳答案。",
            # "根据一般常识，阅读每个假想情景，并从'A'、'B'或'C'中选择最适当的答案。",
            # "基于日常常识推断，浏览每个假定场景，并从'A'、'B'和'C'选项中选出最合适的答案。",
            # "依据普通的常识推理，阅读每一种假设场景，并从'A'、'B'或'C'中挑选最恰当的答案。",
            # "遵循常识推理，细读每个假设情境，并从选项'A'、'B'或'C'中挑选最适合的答案。",
            # "按常理推断，逐一查看每个设想的场景，并从'A'、'B'和'C'中选择最合适的回答。"
            "Read each hypothetical scenario and choose the most appropriate answer from 'A', 'B' or 'C' based on common sense reasoning.",
            "Using common sense, read each hypothetical scenario and choose the most appropriate answer from options 'A', 'B' or 'C'.",
            "Review each hypothetical scenario one by one and choose the most appropriate response among 'A', 'B', and 'C' based on common sense reasoning.",
            "Using common sense, read each hypothetical situation and choose the most appropriate answer from 'A', 'B', and 'C'.",
            "Using common sense reasoning, read each scenario and choose the best answer from 'A', 'B' or 'C'.",
            "Based on common sense, read each hypothetical scenario and choose the most appropriate answer from 'A', 'B' or 'C'.",
            "Based on common sense reasoning, go through each hypothetical scenario and choose the most appropriate answer from options 'A', 'B' and 'C'.",
            "Read each hypothetical scenario and choose the most appropriate answer from 'A', 'B' or 'C' based on ordinary common sense reasoning.",
            "Follow common-sense reasoning, read each hypothetical situation carefully, and choose the answer that best applies to options 'A', 'B', or 'C'.",
            "Use common sense to look at each imagined scenario one by one and choose the most appropriate answer from 'A', 'B', and 'C'."
        ],
        'french': [
            # "En utilisant le raisonnement de bon sens, lisez chaque scénario hypothétique et choisissez la réponse la plus appropriée parmi 'A', 'B' ou 'C'.",
            # "Avec une logique de sens commun, examinez chaque situation hypothétique et sélectionnez la meilleure réponse entre 'A', 'B' et 'C'.",
            # "Sur la base d'un raisonnement pragmatique, analysez chaque scénario fictif et optez pour la réponse la plus adéquate, soit 'A', 'B', soit 'C'.",
            # "En appliquant le raisonnement intuitif, étudiez chaque cas hypothétique et déterminez la réponse la plus pertinente parmi 'A', 'B', ou 'C'.",
            # "Fondé sur une réflexion rationnelle, considérez chaque scénario hypothétique et choisissez la meilleure option entre 'A', 'B' et 'C'.",
            # "En se basant sur une logique intuitive, évaluez chaque situation fictive et sélectionnez l'option la plus appropriée parmi 'A', 'B' et 'C'.",
            # "En utilisant un raisonnement judicieux, parcourez chaque hypothèse et sélectionnez la réponse la plus convenable, que ce soit 'A', 'B' ou 'C'.",
            # "Avec une approche de bon sens, observez chaque scénario imaginaire et choisissez la réponse la plus juste parmi 'A', 'B', ou 'C'.",
            # "S'appuyant sur une pensée logique, examinez chaque scénario envisagé et optez pour l'alternative la plus adéquate entre 'A', 'B', et 'C'.",
            # "En adoptant un raisonnement sensé, analysez chaque scénario proposé et déterminez la réponse la plus adaptée entre 'A', 'B', et 'C'.",
            "Using common sense reasoning, read each hypothetical scenario and choose the most appropriate answer from 'A', 'B' or 'C'.",
            "With common sense logic, examine each hypothetical situation and select the best answer between 'A', 'B' and 'C'.",
            "Based on pragmatic reasoning, analyze each fictitious scenario and opt for the most appropriate answer, either 'A', 'B' or 'C'.",
            "Applying intuitive reasoning, study each hypothetical case and determine the most relevant answer among 'A', 'B', or 'C'.",
            "Based on rational thinking, consider each hypothetical scenario and choose the best option between 'A', 'B' and 'C'.",
            "Based on intuitive logic, evaluate each fictitious situation and select the most appropriate option from 'A', 'B' and 'C'.",
            "Using sound reasoning, go through each hypothesis and select the most suitable answer, whether 'A', 'B' or 'C'.",
            "With a common sense approach, look at each imaginary scenario and choose the most correct answer from 'A', 'B', or 'C'.",
            "Using logical thinking, examine each scenario considered and choose the most suitable alternative between 'A', 'B', and 'C'.",
            "Using sensible reasoning, analyze each proposed scenario and determine the most appropriate answer between 'A', 'B', and 'C'.",
        ],
        'arabic': [
            # "استنادًا إلى المنطق العام، اقرأ كل سيناريو افتراضي واختر الإجابة الأنسب من 'أ'، 'ب'، أو 'ج'."
            # "على أساس التفكير المنطقي، استعرض كل حالة وهمية وحدد الخيار الأمثل من بين 'أ'، 'ب'، أو 'ج'."
            # "معتمدين على الاستدلال السليم، راجع كل موقف تخيلي واختر الإجابة الأفضل من الخيارات 'أ'، 'ب'، أو 'ج'."
            # "اعتمادًا على العقلانية، قم بقراءة كل سيناريو افتراضي واختر الإجابة الأكثر ملاءمة من 'أ'، 'ب'، أو 'ج'."
            # "بناءً على الاستنتاج السليم، تفحص كل سيناريو تخيلي واختر الأنسب من بين 'أ'، 'ب'، أو 'ج'."
            # "بالاعتماد على التفكير المنطقي، فحص كل وضع افتراضي واختيار الخيار الأمثل من 'أ'، 'ب'، أو 'ج'."
            # "من خلال الاعتماد على المنطق السليم، قم بدراسة كل حالة خيالية واختر الجواب الأفضل من الخيارات 'أ'، 'ب'، أو 'ج'."
            # "بالاستناد إلى الاستدلال المنطقي، انظر إلى كل سيناريو تخيلي وحدد الاختيار الأفضل من 'أ'، 'ب'، أو 'ج'."
            # "وفقًا للتفكير السليم، قم بتقييم كل سيناريو فرضي واختر الأنسب من 'أ'، 'ب'، أو 'ج'."
            # "اعتمادًا على الاستنتاج العقلاني، استكشف كل سيناريو محتمل واختر الخيار الأكثر ملائمة من 'أ'، 'ب'، أو 'ج'."
            "Based on general reasoning, read each hypothetical scenario and choose the most appropriate answer from 'A', 'B', or 'C'.",
            "Based on logical reasoning, review each imaginary situation and select the optimal option among 'A', 'B', or ‘C’.",
            "Based on sound reasoning, review each imaginary situation and choose the best answer from options 'A', 'B', or 'C'.",
            "Depending on your rationality, read each hypothetical scenario and choose the most appropriate answer from 'A', 'B', or 'C'.",
            "Based on sound reasoning, examine each imaginary scenario and choose the most appropriate one among ‘A’, ‘B’, or ‘C’.",
            "Based on logical reasoning, examine each hypothetical situation and choose the optimal option from 'A', 'B', or 'C'.",
            "By relying on common sense, examine each fictional situation and choose the best answer from options 'A', 'B', or 'C'.",
            "Based on logical reasoning, look at each imaginary scenario and make the best choice of ‘A’, ‘B’, or ‘C’.",
            "Based on sound reasoning, evaluate each hypothetical scenario and choose the most appropriate one from ‘A’, ‘B’, or ‘C’.",
            "Based on rational deduction, explore each possible scenario and choose the most appropriate option from 'A', 'B', or 'C'."
        ],
        'spanish': [
            # "Basándose en el razonamiento de sentido común, lea cada escenario hipotético y seleccione la respuesta más apropiada entre 'A', 'B' o 'C'."
            # "Utilizando el razonamiento lógico, examine cada situación hipotética y elija la opción más adecuada: 'A', 'B' o 'C'."
            # "Aplique el razonamiento práctico, analice cada escenario imaginario y escoja la mejor alternativa entre 'A', 'B' y 'C'."
            # "Con base en la lógica de sentido común, evalúe cada caso hipotético y determine la respuesta correcta, ya sea 'A', 'B' o 'C'."
            # "Haciendo uso del razonamiento sensato, considere cada supuesto escenario y decida cuál es la opción más apropiada: 'A', 'B' o 'C'."
            # "Empleando el juicio común, observe cada escenario teórico y seleccione la elección más pertinente entre 'A', 'B' y 'C'."
            # "Mediante el uso de razonamiento lógico común, estudie cada situación hipotética y escoja la más adecuada entre 'A', 'B' o 'C'."
            # "Apoyándose en el razonamiento intuitivo, contemple cada escenario hipotético y elija la respuesta más acertada, 'A', 'B' o 'C'."
            # "Usando el sentido común para razonar, analice cada posible situación y determine la mejor respuesta, sea 'A', 'B' o 'C'."
            # "Con un enfoque en el razonamiento práctico, revise cada hipótesis presentada y opte por la alternativa más acertada: 'A', 'B' o 'C'."
            "Based on common sense reasoning, read each hypothetical scenario and select the most appropriate answer from 'A', 'B' or 'C'.",
            "Using logical reasoning, examine each hypothetical situation and choose the most appropriate option: 'A', 'B' or 'C'.",
            "Apply practical reasoning, analyze each imaginary scenario and choose the best alternative between 'A', 'B' and 'C'.",
            "Based on common sense logic, evaluate each hypothetical case and determine the correct answer, whether 'A', 'B', or 'C'.",
            "Using sound reasoning, consider each hypothetical scenario and decide which is the most appropriate option: 'A', 'B' or 'C'.",
            "Using common judgment, look at each theoretical scenario and select the most relevant choice among 'A', 'B' and 'C'.",
            "Using common logical reasoning, study each hypothetical situation and choose the most appropriate one among 'A', 'B' or 'C'.",
            "Relying on intuitive reasoning, consider each hypothetical scenario and choose the most accurate answer, 'A', 'B' or 'C'.",
            "Using common sense reasoning, analyze each possible situation and determine the best answer, whether 'A', 'B' or 'C'.",
            "With a focus on practical reasoning, review each hypothesis presented and opt for the most accurate alternative: 'A', 'B' or 'C'.",
        ],
        'japanese': [
            # 「常識的な推理に基づいて、各仮想シナリオを読み、'A'、'B'、または'C'の中から最も適切な答えを選んでください。」
            # 「一般的な理解に基づき、それぞれの想定されるシチュエーションを読み、'A'、'B'、'C'の中から最良の答えを選択してください。」
            # 「常識を使って、各仮定された状況を読み、'A'、'B'、'C'から最も適した答えを選びなさい。」
            # 「普通の判断力に基づいて、それぞれの偽のシナリオを読み、'A'、'B'、または'C'の中で最もふさわしい回答を選んでください。」
            # 「通常の論理で、各架空のシナリオを読み、'A'、'B'、'C'のうち最も妥当な答えを選択してください。」
            # 「一般的な判断により、各想像上の状況を読み解き、'A'、'B'、'C'の中からもっとも適切な回答を選んでください。」
            # 「常識に則った推論で、各様々なシナリオを読み、'A'、'B'、'C'の中から最も正しい答えを選んでください。」
            # 「普遍的な理解力を用いて、それぞれの想定される状況を読み、'A'、'B'、または'C'から最適な答えを選択してください。」
            # 「日常的な思考で、各仮説的なシナリオを検討し、'A'、'B'、'C'の中から最も適合する回答を選び出してください。」
            # 「普段の判断力を駆使して、各種の仮設されたシチュエーションを読み、'A'、'B'、'C'の中で一番相応しい答えを選んでください。」
            "Based on common sense reasoning, read each hypothetical scenario and choose the most appropriate answer: 'A', 'B', or 'C'.",
            "Based on your general understanding, read each possible situation and choose the best answer from 'A', 'B', and 'C'.",
            "Use common sense to read each hypothetical situation and choose the best answer from 'A', 'B', and 'C'.",
            "Use common judgment to read each false scenario and choose the best answer: 'A', 'B', or 'C'.",
            "Using normal logic, read each hypothetical scenario and choose the most plausible answer: 'A', 'B', or 'C'.",
            "Use your general judgment to interpret each imaginary situation and choose the most appropriate answer from 'A', 'B', and 'C'.",
            "Use common sense reasoning to read each of the various scenarios and choose the most correct answer from 'A', 'B' and 'C'.",
            "Use your universal understanding to read each possible situation and choose the best answer from 'A', 'B', or 'C'.",
            "Using everyday thinking, consider each hypothetical scenario and choose the best answer from 'A', 'B', and 'C'.",
            "Use your normal judgment to read the various hypothetical situations and choose the most appropriate answer from 'A', 'B', and 'C'.",
        ],
        'korean': [
            # "상식적인 추론을 바탕으로, 각 가상 시나리오를 읽고 'A', 'B', 'C' 중에서 가장 적절한 답을 고르세요."
            # "일반적인 상식을 이용하여, 다양한 가상 상황을 읽고 'A', 'B', 'C' 중 가장 알맞은 대답을 선택하세요."
            # "흔히 알려진 상식을 근거로 하여, 각각의 가상적인 시나리오를 읽고, 'A', 'B', 'C' 중 가장 적합한 답을 고르십시오."
            # "보통의 상식을 사용하여, 여러 가상 상황들을 읽고 'A', 'B', 'C' 중에서 가장 적절한 답변을 선택하십시오."
            # "상식적인 판단을 바탕으로, 각기 다른 가상 시나리오들을 읽고 'A', 'B', 'C' 옵션 중 최적의 답을 골라주세요."
            # "기본적인 상식을 적용하여, 여러 가상의 상황들을 읽고 'A', 'B', 'C' 중 가장 적절한 선택을 하세요."
            # "일반 상식에 따라, 각각의 가상 시나리오를 읽고 'A', 'B', 'C' 중에서 가장 적합한 답을 선택하십시오."
            # "상식적 사고를 바탕으로, 다양한 가상 시나리오들을 읽고 'A', 'B', 'C' 중 가장 알맞은 답을 고르세요."
            # "통상적인 상식을 이용해, 각각의 가상적 상황들을 읽고 'A', 'B', 'C' 중 가장 적절한 대답을 선택하세요."
            # "일상적인 상식을 활용하여, 여러 가상 시나리오들을 읽고 'A', 'B', 'C' 중 가장 적합한 선택을 하십시오."
            "Based on common sense reasoning, read each hypothetical scenario and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Using your general knowledge, read various hypothetical situations and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Based on commonly known common sense, read each hypothetical scenario and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Using common sense, read several hypothetical situations and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Based on common sense, read different hypothetical scenarios and choose the best answer among options 'A', 'B', and 'C'.",
            "Apply basic common sense, read several hypothetical situations and make the most appropriate choice among 'A', 'B', and 'C'.",
            "Based on your general knowledge, read each hypothetical scenario and choose the best answer among 'A', 'B', and 'C'.",
            "Based on common sense, read various hypothetical scenarios and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Using common sense, read each hypothetical situation and choose the most appropriate answer among 'A', 'B', and 'C'.",
            "Use your common sense, read through several hypothetical scenarios and choose the most appropriate choice among 'A', 'B' and 'C'.",
        ],
    },
}
