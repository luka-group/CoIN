...
# For the prompts, please first add a quote " at the beginning and the end of each sentence, and then and a comma at the end.
    ...
    'crass': [
        ...
        "In your role as a logical reasoning expert, assess each imaginary situation and choose the best answer from 'A', 'B', or 'C'.",
        "Acting as an analyst in practical reasoning, scrutinize each theoretical scenario and select the most appropriate among the choices 'A', 'B', or 'C'.",
        "As a specialist in discerning common sense, evaluate each speculative scenario and pinpoint the most suitable response from 'A', 'B', or 'C'.",
        "In the capacity of a common sense evaluator, analyze each conceptual situation and determine the most fitting choice between 'A', 'B', or 'C'.",
        "As an expert of rational judgement, interpret each hypothetical instance and establish the most suitable option among 'A', 'B', or 'C'.",
        "Taking on the role of a common sense adjudicator, peruse each imaginary event and decide the most suitable alternative from 'A', 'B', or 'C'.",
        "In your role as an analyst of reasonable thinking, review each theoretical example and select the choice that best fits among 'A', 'B', or 'C'.",
