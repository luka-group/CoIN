...
# For the prompts, please first add a quote " at the beginning and the end of each sentence, and then and a comma at the end.
    ...
    # Paraphrase the following instruction for 10 times and return the result in a python list format.
    ...
    'crass': [
        ...
        "Using common sense reasoning, assess each theoretical situation and identify the most suitable option, either 'A', 'B', or 'C'.",
        "Apply common sense reasoning skills to each speculative scenario and select the most appropriate choice from 'A', 'B', or 'C'.",
        "Draw on common sense to interpret each conjectural situation and pick the most fitting answer from choices 'A', 'B', or 'C'.",
        "Leverage common sense understanding to review each fictional scenario and decide on the most relevant answer among 'A', 'B', or 'C'.",
        "Apply common sense reasoning on each hypothetical case and elect the most appropriate response from 'A', 'B', or 'C'.",
        "Rely on common reasoning to examine each hypothetical scenario and select the most apt answer from options 'A', 'B', or 'C'.",
        "Employ intuitive reasoning to scrutinize each imagined situation and opt for the most fitting answer among 'A', 'B', or 'C'.",
    ],
}
